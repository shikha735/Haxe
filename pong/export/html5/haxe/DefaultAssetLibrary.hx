...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("star.png/star.png", __ASSET__star_png_star_png);
...
@:keep @:bind #if display private #end class __ASSET__star_png_images_go_here_txt extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
